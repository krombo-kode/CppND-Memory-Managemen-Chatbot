...
ChatLogic::~ChatLogic()
{
    ...
    // // delete all nodes
    // // Don't need to explicitly call delete, as nodes are smart-pointers, and will delete themselves when they fall out of scope.
    ...
    // // delete all edges
    // // Same as delete for nodes. Not required as smart pointers handle cleanup.
